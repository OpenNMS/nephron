...
public class CortexIoPipelineIT {
    ...
    public void manyWindowsSamples() {
        ...
        // -> window completion are processed in parallel and may happen out of order
        // -> metrics get written out of order
        // -> cortex responds with an error in case of outdated samples
        ...
        System.out.println("allMetrics: " + pipelineResult.metrics().allMetrics());

        pipelineResult.metrics().allMetrics().getCounters().forEach(mr -> {
        ...
        LOG.debug("responseFailures: " + responseFailures);
        ...
        ValidatableResponse asserted = response
                .then()
                .assertThat()
        ...
        assertThat("number of response failures does not match size of distinct values - responseFailures: " + responseFailures + "; missing: " + missing + "; response: " + responseString, distinct.size(), is(windows - responseFailures));
