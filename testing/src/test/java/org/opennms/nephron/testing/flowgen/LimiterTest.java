...
public class LimiterTest {
    ...
    public boolean checkpointsDoNotInfluenceTheRate(
        ...
        // check that two parallel limiters agree on the outcome of their check method
        // -> the first limiter does not take part in checkpoints
        // -> checkpoints of the second limiter are taken at arbitrary points and restored on the next check call
