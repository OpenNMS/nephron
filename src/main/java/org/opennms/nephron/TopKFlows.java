...
public class TopKFlows {
    ...
    public long getWindowMinMs() {
        return windowMinMs;
    }

    public void setWindowMinMs(long windowMinMs) {
        this.windowMinMs = windowMinMs;
    }

    public long getWindowMaxMs() {
        return windowMaxMs;
    }

    public void setWindowMaxMs(long windowMaxMs) {
        this.windowMaxMs = windowMaxMs;
    }

    public Map<String, FlowBytes> getFlows() {
        return flows;
    }

    public void setFlows(Map<String, FlowBytes> flows) {
        this.flows = flows;
    }
