...
public class FlowDocument {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FlowDocument)) return false;
        FlowDocument that = (FlowDocument) o;
        return timestamp == that.timestamp &&
                flowRecords == that.flowRecords &&
                flowSeqNum == that.flowSeqNum &&
                ...
                Objects.equals(convoKey, that.convoKey) &&
                direction == that.direction &&
                Objects.equals(dstAddr, that.dstAddr) &&
                Objects.equals(dstAddrHostname, that.dstAddrHostname) &&
                Objects.equals(dstAs, that.dstAs) &&
                dstLocality == that.dstLocality &&
                Objects.equals(dstMaskLen, that.dstMaskLen) &&
                Objects.equals(dstPort, that.dstPort) &&
                Objects.equals(engineId, that.engineId) &&
                Objects.equals(engineType, that.engineType) &&
                Objects.equals(firstSwitched, that.firstSwitched) &&
                flowLocality == that.flowLocality &&
                Objects.equals(inputSnmp, that.inputSnmp) &&
                Objects.equals(ipProtocolVersion, that.ipProtocolVersion) &&
                Objects.equals(lastSwitched, that.lastSwitched) &&
                Objects.equals(nextHop, that.nextHop) &&
                Objects.equals(nextHopHostname, that.nextHopHostname) &&
                Objects.equals(outputSnmp, that.outputSnmp) &&
                Objects.equals(packets, that.packets) &&
                Objects.equals(protocol, that.protocol) &&
                samplingAlgorithm == that.samplingAlgorithm &&
                Objects.equals(samplingInterval, that.samplingInterval) &&
                Objects.equals(srcAddr, that.srcAddr) &&
                Objects.equals(srcAddrHostname, that.srcAddrHostname) &&
                Objects.equals(srcAs, that.srcAs) &&
                srcLocality == that.srcLocality &&
                Objects.equals(srcMaskLen, that.srcMaskLen) &&
                Objects.equals(srcPort, that.srcPort) &&
                Objects.equals(tcpFlags, that.tcpFlags) &&
                Objects.equals(deltaSwitched, that.deltaSwitched) &&
                Objects.equals(tos, that.tos) &&
                netflowVersion == that.netflowVersion &&
                Objects.equals(vlan, that.vlan) &&
                Objects.equals(nodeDst, that.nodeDst) &&
                Objects.equals(nodeExporter, that.nodeExporter) &&
                Objects.equals(nodeSrc, that.nodeSrc);
    }

    @Override
    public int hashCode() {
        return Objects.hash(timestamp, version, host, hosts, location, application, bytes, convoKey, direction, dstAddr, dstAddrHostname, dstAs, dstLocality, dstMaskLen, dstPort, engineId, engineType, firstSwitched, flowLocality, flowRecords, flowSeqNum, inputSnmp, ipProtocolVersion, lastSwitched, nextHop, nextHopHostname, outputSnmp, packets, protocol, samplingAlgorithm, samplingInterval, srcAddr, srcAddrHostname, srcAs, srcLocality, srcMaskLen, srcPort, tcpFlags, deltaSwitched, tos, netflowVersion, vlan, nodeDst, nodeExporter, nodeSrc);
    }
}
